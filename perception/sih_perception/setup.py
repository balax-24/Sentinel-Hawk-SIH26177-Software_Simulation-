...
setup(
    ...
    description="Vision and survivor detection package for SIH26177.",
    license="Apache-2.0",
    tests_require=["pytest"],
    entry_points={
        "console_scripts": [
            "optical_depth_node = sih_perception.optical_depth_node:main",
            "survivor_detector_node = sih_perception.survivor_detector_node:main",
        ],
    },
)
