...
setup(
    ...
    description="Gazebo disaster simulation world and simulated UAV platform for SIH26177.",
    license="Apache-2.0",
    tests_require=["pytest"],
    entry_points={
        "console_scripts": [
            "mock_sim_node = simulation.mock_sim_node:main",
        ],
    },
)
